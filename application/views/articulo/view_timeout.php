        ...
        <div class="postcontent nobottommargin col_last">
            <div id="posts" class="events small-thumbs">
              ...
              <div class="col-md-12">
                      <div class="col-md-12">
                          <br>
                          <h3 style = "color: black;"><?php echo lang('at_articulos en timeout'); ?></h3>
                          <hr>
                      </div>
              ...
              <div class="col-md-12">
                  ...
                  <table id="articulos" class="display" width="100%" cellspacing="0">
                          <thead>
                              <tr>
                                  <th><?php echo lang('at_titulo'); ?></th>
                                  <th><?php echo lang('at_autor'); ?></th>
                                  <th><?php echo lang('at_estado'); ?></th>
                                  <th><?php echo lang('at_revisor N1'); ?></th>
                                  <th><?php echo lang('at_revisor N2'); ?></th>
                                  <th><?php echo lang('at_revisor N3'); ?></th>
                                  <th><?php echo lang('at_fecha ingreso'); ?></th>
                                  <th><?php echo lang('at_archivo'); ?></th>
                                  <th><?php echo lang('at_aceptar con c_rech'); ?></th>
                              </tr>
                          </thead>
                          <tbody>
                          <?php if($datos){ ?>
                            ...
                            $archivo      =   $row->archivo;
                  					...
                  					echo "<tr>";
                  						...
                  						echo "<td>"; echo "<a href='".base_url()."index.php/articulo_editor/timeout_aceptar_rechazar/".$id_revista."'><center><i class='material-icons' style='font-size:40px;'>feedback</i></center>"; 	echo "</td>";
                  					echo "</tr>";
                  				?>
                  			<?php endforeach ?>
