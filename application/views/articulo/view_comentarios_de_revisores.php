        ...
        <div class="postcontent nobottommargin col_last">
            <div id="posts" class="events small-thumbs">
              ...
              <div class="col-md-12">
                      <div class="col-md-12">
                          <br>
                          <h3 style = "color: black;"><?php echo lang('acdr_comentarios de revisores'); ?></h3>
                          <hr>
                      </div>
              ...
              <div class="col-md-12">
                  ...
                  <table id="articulos" class="display" width="100%" cellspacing="0">
                          <thead>
                              <tr>
                                  <th> <?php echo lang('acdr_titulo'); ?></th>
                                  <th><?php echo lang('acdr_autor'); ?></th>
                                  <th><?php echo lang('acdr_estado'); ?></th>
                                  <th><?php echo lang('acdr_fecha ingreso'); ?></th>
                                  <th><?php echo lang('acdr_comentarios'); ?></th>
                                  <th><?php echo lang('acdr_acep_rech'); ?></th>
                              </tr>
                          </thead>
                          <tbody>
                          <?php if($datos){ ?>
                          	<?php foreach ($datos->result() as $row): ?>
                  				<?php
                  					...
                  					echo "<tr>";
                  						...
                  						echo "<td>"; echo "<a href='".base_url()."index.php/articulo_editor/comentarios_de_revisores_ver/".$id_revista."'><center><i class='material-icons' style='font-size:40px;'>zoom_in</i></center>"; echo "</td>";
                  						echo "<td>"; echo "<a href='".base_url()."index.php/articulo_editor/comentarios_de_revisores_aceptar_rechazar/".$id_revista."'><center><i class='material-icons' style='font-size:40px;'>feedback</i></center>"; 	echo "</td>";
                  					echo "</tr>";
                  				?>
                  			<?php endforeach ?>
