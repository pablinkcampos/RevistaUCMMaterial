        ...
        <div class="postcontent nobottommargin col_last">
            <div id="posts" class="events small-thumbs">
							<div class="col-md-12">
					            <div class="col-md-12">
					                <br>
					                <h3 style = "color: grey;"><?php echo lang('amav_informacion articulo'); ?></h3>
                ...
                if (!($id_estado >= 5 &&  $id_estado <= 13))
                {
                  $comentario_revisor_1 = "";
                  $comentario_revisor_2 = "";
                  $comentario_revisor_3 = "";
                }
					            ...
					            echo "<tr>";
					            echo "<th style='text-align: right;' style='text-align: right;'>".lang("amav_id-articulo").":</th>";
					            echo "<td >".$id_revista."</td>";
					            echo "</tr>";

					            echo "<tr>";
					            echo "<th style='text-align: right;'>".lang("amav_titulo articulo").":</th>";
					            echo "<td>".$titulo_revista."</td>";
					            echo "</tr>";

					            echo "<tr>";
					            echo "<th style='text-align: right;'>".lang("amav_version").":</th>";
					            echo "<td>".$version."</td>";
					            echo "</tr>";
					            ...
					            //Autor
					            echo "<tr>";
					            echo "<th style='text-align: right;'>".lang("amav_autor").":</th>";
					            ...
					            echo "<tr>";
					            echo "<th style='text-align: right;'>".lang("amav_campo de investigacion").":</th>";
					            ...
					            //Estado
					            echo "<tr>";
					            echo "<th style='text-align: right;'>".lang("amav_estado").":</th>";
					            ...
					            echo "<tr>";
					            echo "<th style='text-align: right;'>".lang("amav_palabras claves").":</th>";
					            echo "<td>".$palabras_claves."</td>";
					            echo "</tr>";

					            echo "<tr>";
					            echo "<th style='text-align: right;'>".lang("amav_abstract").":</th>";
					            echo "<td style='text-align: justify;'>".$abstract."</td>";
					            echo "</tr>";

					            echo "<tr>";
					            echo "<th style='text-align: right;'>".lang("amav_archivo:").":</th>";
					            echo "<td><a href='".base_url()."uploads/".$archivo."'>".$archivo."</a></td>";
					            echo "</tr>";

					            echo "<tr>";
					            if($comentarios==""){
					            	echo "<th style='text-align: right;'>".lang("amav_comentarios").":</th>";
						            echo "<td>-</td>";
						            echo "</tr>";
					            }else{
					            	echo "<th style='text-align: right;'>".lang("amav_comentarios").":</th>";
					            ...
					            echo "<tr>";
					            echo "<th style='text-align: right;'>".lang("amav_fecha ultima actualizacion").":</th>";
					            echo "<td>".$fecha_ultima_upd."</td>";
					            echo "</tr>";

					            echo "<tr>";
					            echo "<th style='text-align: right;'>".lang("amav_fecha ingreso articulo").":</th>";
					            ...
					            if($comentario_revisor_1==""){
					            	echo "<th style='text-align: right;'>".lang("amav_comentario revisor 1").":</th>";
						            echo "<td>-</td>";
						            echo "</tr>";
					            }else{
						            echo "<th style='text-align: right;'>".lang("amav_comentario revisor 1").":</th>";
					            ...
					            if($comentario_revisor_2==""){
					            	echo "<th style='text-align: right;'>".lang("amav_comentario revisor 2").":</th>";
						            echo "<td>-</td>";
						            echo "</tr>";
					            }else{
						            echo "<th style='text-align: right;'>".lang("amav_comentario revisor 2").":</th>";
					            ...
					            if($comentario_revisor_3==""){
					            	echo "<th style='text-align: right;'>".lang("amav_comentario revisor 3").":</th>";
						            echo "<td>-</td>";
						            echo "</tr>";
					            }else{
						            echo "<th style='text-align: right;'>".lang("amav_comentario revisor 3").":</th>";
					            ...
					            if($comentarios_editor==""){
					            	echo "<th style='text-align: right;'>".lang("amav_comentarios editor").":</th>";
						            echo "<td>-</td>";
						            echo "</tr>";
					            }else{
						            echo "<th style='text-align: right;'>".lang("amav_comentarios editor").":</th>";
					            ...
					            echo "<tr>";
					            if($fecha_timeout==""){
					            	echo "<th style='text-align: right;'>".lang("amav_fecha timeout").":</th>";
						            echo "<td>-</td>";
						            echo "</tr>";
					            }else{
						            echo "<th style='text-align: right;'>".lang("amav_fecha timeout").":</th>";
							...
							<div class="form-group">
								<div class="col-md-offset-3 col-md-7">
									<form action="<?php echo base_url();?>index.php/articulo_autor/mis_articulos">
											<input type="submit" class="button button-3d button-mini button-rounded button-blue btn-block" value="<?php echo lang('amav_regresar'); ?>" />
									</form>
								</div>
							</div>
            </div>
